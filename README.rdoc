...
{Website}[http://rubyworks.github.com/rebecca] |
{Development}[http://github.com/rubyworks/rebecca]


== Welcome

Ah, she will snare you. Her svelt lines, her 
Rebecca harnesses the powers of the Shomen standard documentation model,
and is built on a jQuery powerhouse, to deliver a sleek and highly usable
documentation browser.


== Features

* Dropdown search ribbon makes it a snap locate documents, classes and methods.
* Built on JQuery, JQuery Templates and other well supported Javascript tools.
* Easily personalize design to best fit your project.
...
webite directory (or `gh-pages` branch if you are crazy like that).
  ...
  $ cd myproject
  $ git clone http://rubyworks.github.com/rebecca.git site
  $ cd site
  $ rm -rf .git
...
in the URL to the location of the file, e.g.
  ...
  http://rubyworks.github.com/rebecca?doc=http://myorg.github.com/myapp/myapp-1.0.0.json
